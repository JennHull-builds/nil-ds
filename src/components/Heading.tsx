...
const levelStyle: Record<NonNullable<HeadingProps['level']>, React.CSSProperties> = {
  1: { fontSize: 'var(--primitive-type-scale-2xl)', fontWeight: 800, lineHeight: 1.05 },
  2: { fontSize: 'var(--primitive-type-scale-xl)', fontWeight: 700, lineHeight: 1.15 },
  3: { fontSize: 'var(--primitive-type-scale-lg)', fontWeight: 600, lineHeight: 1.25 },
};
