  ...
  return (
    <div
      ...
      style={{
        ...
        padding: 'var(--primitive-spacing-2xl) var(--primitive-spacing-lg)',
      }}
    >
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        >
          <div>
            <Heading level={1}>design-foundry</Heading>
            <Text muted>
              Token + primitive kit, extracted from mothership-stable. Working name, DRAFT — see README.
            </Text>
          </div>
          <Button
            variant="secondary"
        ...
        <Divider spacing="var(--primitive-spacing-2xl)" />

        <Heading level={2}>Buttons</Heading>
        <Text muted size="sm">Variants and sizes, all reading semantic tokens only.</Text>
        <div style={{ display: 'flex', gap: 'var(--primitive-spacing-sm)', flexWrap: 'wrap', marginTop: 'var(--primitive-spacing-md)' }}>
        ...
        <div style={{ marginTop: 'var(--primitive-spacing-md)' }}>
          <Grid columns={3}>
            <Card>
        ...
        <div style={{ maxWidth: 320, marginTop: 'var(--primitive-spacing-md)', display: 'flex', flexDirection: 'column', gap: 'var(--primitive-spacing-md)' }}>
