    ...
    <DemoScene id="climate" ref={ref}>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'center', padding: 'var(--nil-spacing-md)' }}>
          <Dial value="18.5" unit="°C" sublabel="Target" progress={62} size="lg" label="Kitchen" />
        </div>
      ...
      >
        <Panel title="Schedule">
          ...
          <div style={{ display: 'flex', gap: 'var(--nil-spacing-sm)', marginTop: 'var(--nil-spacing-md)', flexWrap: 'wrap' }}>
            <Toggle checked={weekdayOn} onCheckedChange={setWeekdayOn} labelOn="ON" labelOff="OFF" />
            <Toggle checked={dayOffOn} onCheckedChange={setDayOffOn} />
          </div>
        </Panel>
      </div>
      ...
      <div
        className={`nil-enter${visible ? ' is-visible' : ''}`}
        style={{ marginTop: 'var(--nil-spacing-md)', maxWidth: 200, ['--nil-anim-delay' as string]: '200ms' }}
      >
